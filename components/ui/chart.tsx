            ...
            <ChartContext.Provider value={{ config }}>
                ...
                >
                    ...
                    <RechartsPrimitive.ResponsiveContainer>
                        {/* Always render children, cast as ReactElement to satisfy type */}
...
interface ChartTooltipContentProps extends Omit<React.ComponentProps<typeof RechartsPrimitive.Tooltip>, 'formatter' | 'labelFormatter'> {
    hideLabel?: boolean;
    ...
    className?: string;
    label?: string;
    labelFormatter?: (label: string | number, payload?: any) => string | number;
